...
public class Payment2Application {
	...
	private static final Logger log = LoggerFactory.getLogger(Payment2Application.class);
	...
	public String payment() {
		...
		return rest.getForObject("http://localhost:8080/getDiscount", String.class);
	}
